...
(function (global) {
  ...
  const DICT = {
    zh: {
      ...
      ruleStacking: "叠加",
      ruleSevenZero: "7-0换牌",
      ruleDrawToMatch: "摸到能出",
      ruleLastNumber: "数字收尾",
      netRulesByHost: "房主设定",
      netRulesHostSet: "房主设定中",
      waitTurn: "等待 {name} 出牌…",
      connecting: "连接中…",
      gameOver: "游戏结束",
    ...
    en: {
      ...
      // Lobby rule sync display
      ruleStacking: "Stack",
      ruleSevenZero: "7-0 Swap",
      ruleDrawToMatch: "Draw-to-Match",
      ruleLastNumber: "Number End",
      netRulesByHost: "by host",
      netRulesHostSet: "host pending",
